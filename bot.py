# 1. Перейди по этой ссылке в браузере, чтобы получить токен:
...
TOKEN = '8580440024:AAF9CCnrfYcvjQx9acUicb3BBZVCHeTQYaQ'
bot = telebot.TeleBot(TOKEN)

# ⚠️ Вставь сюда полученный токен в кавычки вместо 'ТВОЙ_ТОКЕН_С_ЯХДЕНКСА'
